...
@Component({
  selector: 'app-product-item-old',
  templateUrl: './product-item-old.component.html',
  styleUrls: ['./product-item-old.component.scss'],
  // TODO: update to ngdeep and remove this
  encapsulation: ViewEncapsulation.None,
})
export class ProductItemOldComponent implements OnInit, AfterViewInit, OnDestroy {
