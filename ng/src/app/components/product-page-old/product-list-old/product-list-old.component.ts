...
import animations from './product-list-old.animations';

@Component({
  selector: 'app-product-list-old',
  templateUrl: './product-list-old.component.html',
  styleUrls: ['./product-list-old.component.scss'],
  animations
})
export class ProductListOldComponent implements OnInit, OnDestroy {
